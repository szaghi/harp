...
fun HorizonScreen(vm: HorizonViewModel) {
    ...
    Column(
        ...
        Text(
            ...
            } ?: "no GPS fix - declination assumed 0, grant location and refresh",
            style = MaterialTheme.typography.bodySmall,
        )
        Text(
        ...
        Row(horizontalArrangement = Arrangement.spacedBy(8.dp)) {
            Button(onClick = { vm.addVertex() }) { Text("Add vertex") }
            OutlinedButton(onClick = { vm.removeLast() }) { Text("Undo") }
            OutlinedButton(onClick = { vm.refreshLocation() }) { Text("GPS") }
        }
        Spacer(Modifier.height(12.dp))
        ...
        Button(
            ...
            onClick = {
                ...
                context.startActivity(Intent.createChooser(share, "Share horizon.hrz"))
            },
        ) { Text("Export .hrz") }
